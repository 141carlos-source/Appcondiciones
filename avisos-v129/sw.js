const CACHE='APP-AVISOS-V129-SHELL-8';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.svg','./install.js','./home.js','./suministro.js','./condiciones-flow.js','./layout.js'];
