const CACHE='APP-AVISOS-V129-SHELL-9';
const SHELL=['./','./index.html','./manifest.webmanifest','./icon.svg','./install.js','./home.js','./suministro.js','./condiciones-flow.js','./layout.js','./client-summary.js'];
