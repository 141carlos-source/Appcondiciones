(function(){'use strict';
const BUILD='V135-AGENDA-CLOSEFIX1';let W=null,timer=0,full=false;
...
function ensureFrame(){const f=e('agenda135-frame');if(f&&!f.getAttribute('src'))f.src='./agenda.html?embedded=1&v=V135-AGENDA-CLOSEFIX1'}
