(function(){'use strict';
const BUILD='V135-AVISOS1';
let checking=false,lastCheck=0;
function loadAvisosCliente(){try{if(!document.getElementById('s135AvisosCliente')){let s=document.createElement('script');s.id='s135AvisosCliente';s.src='./avisos135cliente.js?build='+encodeURIComponent(BUILD)+'&t='+Date.now();document.head.appendChild(s)}else if(window.Soltec135AvisosCliente&&window.Soltec135AvisosCliente.init){window.Soltec135AvisosCliente.init()}}catch(e){}}
...
window.Soltec134AppUpdate={BUILD,check,loadAvisosCliente};
loadAvisosCliente();
