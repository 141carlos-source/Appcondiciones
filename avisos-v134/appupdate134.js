(function(){'use strict';
const BUILD='V135-SYNC-MOVIL-CIERRE1';
...
window.Soltec134AppUpdate={BUILD,check,loadAvisosCliente,loadSafe,loadRecovery,loadRevFix,loadPartsNew,loadMobileClose};
loadAvisosCliente();
