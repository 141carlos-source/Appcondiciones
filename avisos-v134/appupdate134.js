...
function loadRecovery(){try{if(!document.getElementById('s134Recovery')){let s=document.createElement('script');s.id='s134Recovery';s.src='./sync134recovery.js?build='+encodeURIComponent(BUILD)+'&t='+Date.now();document.head.appendChild(s)}else if(window.Soltec134Recovery&&window.Soltec134Recovery.init){window.Soltec134Recovery.init()}}catch(e){}}
...
window.Soltec134AppUpdate={BUILD,check,loadAvisosCliente,loadSafe,loadRecovery};
loadAvisosCliente();
